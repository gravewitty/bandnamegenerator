...
app.post("/submit", (req, res) => {
  ...
  var adjrandomNo = Math.floor(Math.random() * adj.length + 1);
  var nounrandomNo = Math.floor(Math.random() * noun.length + 1);
  var adjposition = adj[adjrandomNo];
  var nounposition = noun[nounrandomNo];
  var addBoth = adjposition + nounposition;
